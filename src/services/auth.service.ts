...
import { CreateUserDto, CreateUserDto2 } from '../dtos/users.dto';
...
class AuthService {
  ...
  public async signup(userData: CreateUserDto2): Promise<string> {
    ...
    u.slug = slugify(u.nom);
    u.nom = userData.nom;
    u.prenon = userData.prenom;
    u.birthDate = userData.birthDate;
    u.pays = userData.pays;
